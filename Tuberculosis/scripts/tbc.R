...
jenks <- classIntervals(shp_dis_tbc$Tasa_incidencia, n = 5, style = "jenks")
...
colores_categorias <- c("1700.8–2694.9" = "#ee3d45", "643.1–1700.8" = "#f1646a", "206.8–643.1" = "#f58b8f", "74.9–206.8" = "#f8b1b5", "0–74.9" = "#fcd8da")
...
ggsave(plot = map, "imagenes/map_tbc.png", width = 2500, height = 2000, units = "px")
