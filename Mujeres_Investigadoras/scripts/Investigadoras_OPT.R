...
# Unir datos de INVESTIGADORES  al shapefile de departamento
shp_dep_inves <- shp_departamentos |> left_join(investigadores, by = c("CCDD"="IID_REG"))
...
# Crear etiquetas automáticas con rangos reales
etiquetas <- paste0(
...
shp_dep_inves|>  
  ...
  labs(
    ...
    subtitle = "(n = 4,647)",
    caption = "Fuente:  Registro Nacional Científico, Tecnológico y de Innovación Tecnológica (RENACYT)\nElaboración: Denis Rodríguez (https://denis-rodriguez.com)")+
  ...
  theme(
    ...
    plot.caption = element_text(size=40, color="grey60", hjust=0.0, vjust=0),
...
#ggsave("imagenes/inves_muj_bar.png", width = 8, height = 8, dpi = 320, units = "in")
